...
ALLOWED_VERIFIER_IDS = frozenset({"nintendo_starter_pack", "aurora_faq968", "journey_pack", "moomin_pack", "kizuna_ai_bundle", "skyfest_faq1330_core_five", "tournament_of_triumph_faq1330_core_four", "days_of_color_faq1323_core_three", "days_of_sunlight_faq1343_core_three", "days_of_moonlight_faq1343_core_three", "cinnamoroll_popup_cafe_faq1308", "days_of_fortune_faq1264_core_five", "days_of_love_faq1374_core_four", "days_of_treasure_bloom_faq1381_core_six", "days_of_nature_color_faq1391_core_eleven", "days_of_music_faq1362_core_four", "days_of_mischief_faq1356_core_five", "days_of_bloom_faq1278_core_four", "declarative_v2"})
...
def _verifier(verifier_id: str) -> tuple[Callable[[Path], list[str]], dict[str, object]] | None:
    ...
    if verifier_id == "days_of_treasure_bloom_faq1381_core_six":
        ...
        return verify, registry_contract()
    if verifier_id == "days_of_nature_color_faq1391_core_eleven":
        from tools.normalize.apply_days_of_nature_color_faq1391_core_eleven_cohort import registry_contract, verify
        return verify, registry_contract()
    if verifier_id == "days_of_music_faq1362_core_four":
        from tools.normalize.apply_days_of_music_faq1362_core_four_cohort import registry_contract, verify
        return verify, registry_contract()
    if verifier_id == "days_of_mischief_faq1356_core_five":
        from tools.normalize.apply_days_of_mischief_faq1356_core_five_cohort import registry_contract, verify
        return verify, registry_contract()
    if verifier_id == "days_of_moonlight_faq1343_core_three":
        from tools.normalize.apply_days_of_moonlight_faq1343_core_three_cohort import registry_contract, verify
        return verify, registry_contract()
    if verifier_id == "days_of_bloom_faq1278_core_four":
        from tools.normalize.apply_days_of_bloom_faq1278_core_four_cohort import registry_contract, verify
        return verify, registry_contract()
