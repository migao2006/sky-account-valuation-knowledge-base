...
- 季節 30、活動 24、物品 94、套組 8、別名 324、來源 24。
...
- canonical needs_review 分布為 {"seasons": 27, "events": 13, "items": 94, "sets": 8, "aliases": 310, "availability_events": 8}；另有類別缺口 queue 39 筆、隔離物品候選 622 筆、unmapped alias 13 筆。這些集合可能重疊，不直接相加成唯一項目數。
