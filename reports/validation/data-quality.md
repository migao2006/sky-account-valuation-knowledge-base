...
- 季節 30、活動 24、物品 94、套組 8、別名 322、來源 27。
...
- canonical needs_review 分布為 {"seasons": 27, "events": 13, "items": 90, "sets": 7, "aliases": 308, "availability_events": 8}；另有類別缺口 queue 39 筆、隔離物品候選 622 筆、unmapped alias 14 筆、alias conflict 1 筆。這些集合可能重疊，不直接相加成唯一項目數。
...
- 物品 evidence tier：{"official_with_secondary": 4, "unverified_seed": 90}；模型白名單物品 0 筆。needs_review、候選與衝突別名均不得進入正式 Item Vector。
- visual reference 4、真實 image evidence 0、可驗證成交 0；因此不宣稱圖示辨識準確率或成交價模型。
