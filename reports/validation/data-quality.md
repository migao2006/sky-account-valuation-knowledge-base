...
- 季節 30、活動 24、物品 98、套組 9、別名 322、來源 29。
...
- canonical needs_review 分布為 {"seasons": 27, "events": 13, "items": 85, "sets": 6, "aliases": 308, "availability_events": 8}；另有類別缺口 queue 39 筆、隔離物品候選 622 筆、unmapped alias 14 筆、alias conflict 1 筆。這些集合可能重疊，不直接相加成唯一項目數。
...
- 物品 evidence tier：{"official_with_secondary": 13, "unverified_seed": 85}；模型白名單物品 0 筆。needs_review、候選與衝突別名均不得進入正式 Item Vector。
