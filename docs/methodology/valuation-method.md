...
P0.1 是「可比帳號選擇器」，不是把物品價格相加的報價表。它以帳型、季節結構、物品與套組、完成度、地圖、收藏、資源、綁定、任次、日期和證據品質選擇透明的同類案例。
...
正式市場資料目前只有三筆同時確認幣別為 TWD 且伺服器為國際服，因此結果的適用範圍有限，不代表完整市場。P0.1 不擴充全物品資料、不新增市場資料，也不重新引入回測或網路執行能力。
