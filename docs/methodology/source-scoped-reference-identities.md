...
The summary records the fixed 64 canonical links, 296 candidate links, 1,398
unresolved observations, and 26 quarantined cross-type observations.  It does
not assert 1,758 canonical game items or make any catalog/model promotion.
