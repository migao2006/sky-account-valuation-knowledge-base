...
Formal P3.3 data has 0 externally authorized normal-listing rows, 0 urgent-sale rows,
and 0 verified-sale rows. Nineteen exact-English canonical items are model eligible,
but no authorized price rows exist. The signed-intake v3 contract can bind future
